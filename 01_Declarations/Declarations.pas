...
//Model.ProSu.InterfaceActions, Model.ProSu.Interfaces;
  ...
  TNotificationClass = class (TInterfacedObject, INotificationClass)
    ...
    public
      ...
      property fMemberStraße      : String read fStraße write fStraße;
  ...
  TMember = class
    ...
    // Zugriff auf die Variablen
        ...
        property Straße             : String    read fStraße    write fStraße;
  ...
  TTrainer = class
    ...
    // Zugriff auf die Variablen
      ...
      property  Gültigkeit          : Integer read  fGültigkeit           write fGültigkeit;
